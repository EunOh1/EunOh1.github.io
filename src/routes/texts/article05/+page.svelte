...
<div class='txt-container'>
    <h2 class="txt-title">2016.4.28 교훈의 집적</h2><br>
    <p class='sub-title'>오은</p><br>
    <div class='p-container'>
        <p class="text"> 지난 시대를 ‘불모’ 라고 판단하는 것에는, 모두가 이의가 없을 것이다. 그러나 상황판단 이후에 실질적 작업 전개, 적용이 설득력이 떨어진다면, 결국 그리도 극복하려던 지난 시간의 교훈들로 논파당하고 만다.<br><br>
