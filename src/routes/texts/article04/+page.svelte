...
<div class='txt-container'>
    <h2 class="txt-title">“오늘의 문제적 오브제는 어떻게 조형되는가?“ {'('}요리스라만 랩 / 오은, 정재용 2인전 평론글{')'} 중</h2><br>
    <p class='sub-title'>미술평론가 임근준</p><br>
    <div class='p-container'>
    <p class="text">….(중략) 홍익대 조소과에서 학사와 석사 과정을 마친 오은은, 정재용과 유사하지만 또 다른 방식으로, 한국의 현대조각과 현대회화 작업들을 참조해가며, 메타-소조 작업을 전개했다. 예컨대, 추상적 토르소 작업으로 뵈는 «18 #2(1-62)»(2018)는, 쉽게 설명하면, 박서보의 원형질 연작을 입체로 번역해낸 결과다. 하지만, 그는 원전에 충실한 조형적 번역을 실시하지는 않았다. 사용한 재료는 철, 시멘트, 에폭시, 폴리우레탄 폼, 레진 등이다.<br><br>
