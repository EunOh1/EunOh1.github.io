...
<header style="box-sizing: border-box; padding-top: 0.4vh;">
    <nav class="eun-header">
        <ul class="top-menu">
            <li class="eunoh"><a on:click={eunohClick()} href='/'>EunOh</a></li> 
            {#each items as item}          
...
<footer>
    <div class="footer">
        <p>
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0" id="Layer_1" x="0px" y="0px" width="64px" height="64px" viewBox="5.5 -3.5 64 64" enable-background="new 5.5 -3.5 64 64" xml:space="preserve">
            <g>
