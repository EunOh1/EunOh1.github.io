...
<div class='txt-container'>
    <h2 class="txt-title">2014.11.15 기시감/데자부</h2><br>
    <p class='sub-title'>오은</p><br>
    <div class='p-container'>
        <p class="text"> '오늘' 더 이상 현재-지금은 없다. 오늘의 지금은 일종의 기시감 덩어리이자 데자부의 총체로 이루어져있다. 변화된 미디어 환경, 주거환경, 포스트-전지구화, 기대 감소의 상황 등등은 오늘의 인간이 오늘을 살 수 없게 한다. 오늘의 인간은 마치 시뮬레이션 게임 속의 npc 캐릭터, 아니 사실 그냥 스크린 앞에서 순서에 맞게 버튼을 누르는 그 순간처럼 삶을 살게 되었다.<br><br>
